...
<div id="Cursos1">
    <div id="curso">
            <h4><a id="cursoButton" href="{{ route('site.departamentos.sa') }}">Secretaria Acadêmica</a></h4>
    </div>

    <div id="curso">
            <h4><a id="cursoButton" href="{{ route('site.departamentos.cc') }}">Coordenação de Cursos</a></h4>
    </div>

    <div id="curso">
            <h4><a id="cursoButton" href="{{ route('site.departamentos.dir') }}">Direção</a></h4>
    </div>

    <div id="curso">
            <h4><a id="cursoButton" href="{{ route('site.departamentos.cp') }}">Coordenação Pedagógica</a></h4>
    </div>
</div>

<div id="Cursos2">
    <div id="curso">
            <h4><a id="cursoButton" href="{{ route('site.departamentos.apm') }}">APM</a></h4>
    </div>
</div>
